...
const theoryData = {
  7: {
    ...
    5: {
      title: "Кінематика та Тертя",
      formula: "v = v₀ + a·t | a = g·sinα - μg·cosα",
      description: "Досліджуємо рівномірний та нерівномірний рух тіла на похилій площині. Сила тяжіння розкладається на componentes паралельну та перпендикулярну до площини. Тертя проти дію руху залежить від коефіцієнту тертя та нормальної сили.",
    },
    6: {
      title: "Гідравлічний прес (Закон Паскаля)",
      formula: "F₁/S₁ = F₂/S₂",
      description: "Тиск у рівномірній рідині передається однаково у всіх напрямках. Малу силою на малому поршні можна розвити величезну силу на великому поршні завдяки різниці площ.",
    },
    7: {
      title: "Світло та Тіні (Оптика)",
      formula: "Прямолінійне поширення",
      description: "Світло поширюється прямою лінією у однорідному середовищі. Тінь утворюється через блокування світла непрозорою перешкодою. При розширеному джерелі світла спостерігаємо чітку тінь (умбра) та розмиту півтінь (пенумбра).",
    }
  },
  8: {
    1: {
...
const useStore = create((set) => ({
  ...
  grade7Params: {
    ...
    frictionKinematics: 0.2, // Коефіцієнт тертя для кінематики
    inclineAngle: 30, // Кут нахилу для кінематики
    hydraulicPressure: 50, // Тиск для гідравлічного преса
    lightSourceSize: 20, // Розмір джерела світла
    obstacleSize: 40, // Розмір перешкоди для оптики
    screenDistance: 200, // Відстань до екрану для оптики
  },
